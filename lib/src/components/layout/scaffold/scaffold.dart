...
///
/// {@tool snippet}
/// Add a listener to the app's tab controller so that the [AdaptiveAppBarPage] title of the
...
class AdaptiveScaffold extends StatelessWidget {
  ...
  ///
  /// This is useful if the app bar's [AdaptiveAppBarPage.backgroundColor] is not
  /// completely opaque.
  ///
  ...
  /// [AdaptiveAppBarPage.primary], is true.
  final bool primary;
